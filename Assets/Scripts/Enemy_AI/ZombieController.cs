...
public class ZombieController : MonoBehaviour
{
    ...
    {
        Vector3 targetRot = (destination - transform.position);
        Quaternion.Slerp(Quaternion.Euler(transform.forward), Quaternion.Euler(targetRot), 0.1f);
